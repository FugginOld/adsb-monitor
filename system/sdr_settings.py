"""Airspy / receiver / per-SDR settings — parse, write, and a live hint.
...
No dependency on the presence guard (system/sdr_presence.py) — that module
depends on this one for `_opt_in_receiver`, not the other way round.
